...
const SubComponentForNoReason = () => {
  return (
    <div style={{ padding: 10, border: '1px solid red', marginTop: 10 }}>
      Tôi là một Component con bị nhét chung vào file screen
    </div>
  );
};
...
const AnotherUnrelatedView = () => {
  return (
    <div style={{ padding: 10, border: '1px solid blue', marginTop: 10 }}>
      Tôi đáng lẽ nên là một file riêng biệt
    </div>
  );
};
...
export default function BadPatternScreen() {
  ...
  return (
    <div style={{ padding: 20 }}>
      ...
      <ul style={{ color: 'red' }}>
        <li>
          ❌ <b>Gom cụm:</b> Chứa quá nhiều components (SubComponent, UnrelatedView) trong cùng 1
          file.
        </li>
        <li>
          ❌ <b>Trộn lẫn Logic và UI:</b> Chứa các hàm business logic/utils ngay trong file screen.
        </li>
        <li>
          ❌ <b>Export sai chuẩn:</b> Dùng <code>export default</code> thay vì named export.
        </li>
      </ul>
