...
export function LeakDOMScreen() {
  ...
  return (
    <div>
      ...
      <p>
        Màn hình này liên tục tạo ra các thẻ div có nội dung lớn trong bộ nhớ và lưu vào một mảng toàn cục.
        Vì vẫn còn reference trong mảng này, trình duyệt không thể dọn dẹp các node đó kể cả khi chúng không có mặt trên giao diện (Detached DOM).
      </p>
    </div>
  );
}
